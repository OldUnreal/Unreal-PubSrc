...
var(Display) bool		bUseLitSprite;		// On DT_Sprite, make sprites lit by light sources, while on DT_Mesh it makes lighting ignore face normals.
...
// A skeletal bone received an animation notify (by SkelPlayAnim).
event AnimBoneNotify( int BoneIndex, name NotifyName );
...
// Combinations.
const noexport TRACE_VisBlocking	= {TRACE_Level | TRACE_Movers};
const noexport TRACE_AllColliding	= {TRACE_VisBlocking | TRACE_Pawns | TRACE_Others | TRACE_Volumes};
