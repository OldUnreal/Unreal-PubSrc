...
/*
GL1_PROC(void,glBindBufferARB,(GLenum, GLuint))
GL1_PROC(void,glDeleteBuffersARB,(GLsizei, const GLuint *))
GL1_PROC(void,glGenBuffersARB,(GLsizei, GLuint *))
GL1_PROC(void,glBufferDataARB,(GLenum, GLsizeiptr, const GLvoid *, GLenum))
*/
