...
GL_EXT_PROC(_GL_ARB_vertex_buffer_object,void,glGenBuffersARB,(GLsizei, GLuint *))
GL_EXT_PROC(_GL_ARB_vertex_buffer_object,void,glBindBufferARB,(GLenum, GLuint))
GL_EXT_PROC(_GL_ARB_vertex_buffer_object,void,glDeleteBuffersARB,(GLsizei, const GLuint *))
GL_EXT_PROC(_GL_ARB_vertex_buffer_object,void,glBufferDataARB,(GLenum, GLsizeiptr, const GLvoid *, GLenum))
*/
