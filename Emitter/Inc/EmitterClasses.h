...
class EMITTER_API ASunLight : public ADistantLightActor
{
public:
	FName SunlightZoneTag GCC_PACK(INT_ALIGNMENT);
	DECLARE_CLASS(ASunLight,ADistantLightActor,0,Emitter)
...
VERIFY_CLASS_OFFSET_NODIE_SLOW(A,SunLight,SunlightZoneTag)
VERIFY_CLASS_SIZE_NODIE(ASunLight)
