...
UTexture* URopeMesh::GetTexture(INT Count, AActor* Owner) const
{
	guardSlow(URopeMesh::GetTexture);
	return Owner->Texture;
	unguardSlow;
}
void URopeMesh::GetTextures(UTexture** TexArray, AActor* Owner) const
{
	guardSlow(URopeMesh::GetTextures);
	TexArray[0] = Owner->Texture;
	unguardSlow;
}
